...
type
  ...
  TCustom_Box_Buffer_Decl = {$IFDEF FPC}specialize {$ENDIF FPC} TBigList<TCustom_Box>;
  ...
  TCustom_Box_Queue_Decl = {$IFDEF FPC}specialize {$ENDIF FPC} TBigList<TCustom_Box_Buffer>;
...
begin
  ...
  if bIndex > eIndex then
      TSwap<Integer>.Do_(bIndex, eIndex);
