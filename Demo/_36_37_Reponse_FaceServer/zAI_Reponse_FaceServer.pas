...
uses Types, Classes, SysUtils, IOUtils, Threading, Windows,
  ...
  PasAI.AI, PasAI.AI.Common, PasAI.AI.TrainingTask, PasAI.Learn, PasAI.Learn.Type_LIB, PasAI.Learn.KDTree,
  PasAI.Net;
...
begin
  ...
  Param.SetDefaultValue('source', 'input' + PasAI.AI.Common.C_ImageMatrix_Ext);
  ...
  LockObject(FaceDB);
  tt.Write('input' + PasAI.AI.Common.C_ImageMatrix_Ext, FaceDB, False);
  UnLockObject(FaceDB);
...
begin
  ...
  Face_Learn := TLearn.CreateClassifier(TLearnType.ltKDT, PasAI.AI.C_Metric_Dim);
