...
uses
  FastMM5,
  System.SysUtils,
  PasAI.Core, PasAI.DFE, PasAI.PascalStrings, PasAI.UPascalStrings, PasAI.UnicodeMixedLib, PasAI.Status,
  PasAI.Parsing, PasAI.Expression, PasAI.OpCode, PasAI.MemoryStream,
