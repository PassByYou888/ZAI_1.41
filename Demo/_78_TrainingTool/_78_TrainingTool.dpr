...
uses SysUtils, Windows, ShellAPI,
  ...
  PasAI.AI, PasAI.AI.Common, PasAI.AI.KeyIO, PasAI.AI.TrainingTask;
...
begin
  ...
  if keep <> '' then
      PasAI.AI.KeepPerformanceOnTraining := umlStrToInt(keep, 0);

  if recymem <> '' then
      PasAI.AI.LargeScaleTrainingMemoryRecycleTime := umlStrToInt(recymem, 0);
