...
uses
  ...
  PasAI.Geometry2D, PasAI.Geometry3D, PasAI.Notify,
  PasAI.DrawEngine, PasAI.DrawEngine.SlowFMX, PasAI.MemoryRaster,
  FMX.Controls.Presentation, FMX.StdCtrls;

type
  TAtom_Texture = TAtomVar<TPasAI_Raster>;
...
begin
  inherited Create;
  Texture := TAtom_Texture.Create(NewPasAI_Raster);
  Activted := True;
...
begin
  ...
  while Activted do
    begin
      d.Progress();
      d.PasAI_Raster_.Memory.SetSize(300, 150, RColor(0, 0, 0, 0));
      d.SetSize;
      ...
      // 更新输出光栅
      Texture.Lock;
      Texture.P^.SwapInstance(d.PasAI_Raster_.Memory);
      Texture.P^.Update;
      Texture.UnLock;
    end;
