...
uses Classes, IOUtils, Threading,
  ...
  PasAI.AI, PasAI.AI.Common, PasAI.Learn, PasAI.Learn.Type_LIB,
...
begin
  ...
  face_hnd := ai.Face_Detector(mr, mmod_desc, PasAI.AI.C_Metric_Input_Size);
...
begin
  ...
  // Z.Learn engine
  Face_LearnEng := TLearn.CreateClassifier(ltKDT, PasAI.AI.C_Metric_Dim);
