...
type
  ...
  // TVideo_Data_Load_And_Decode_Bridge被设计成读取数据库并且解码的结构,以此来简化视频合并流程
    ...
    begin
      ...
      if w.EncodeNum >= frame_split then // 达到帧间隔长度
        begin
          ...
          Video_DB.Add_Video_Data(frag_source, frag_clip, psf, begin_frame_id, r.Current_Frame, begin_Time, sim_time, encoder_output);
