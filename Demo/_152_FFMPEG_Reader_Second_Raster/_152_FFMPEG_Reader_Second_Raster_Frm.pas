...
var
  r: TFFMPEG_Reader;
  primary, second: TMPasAI_Raster;
begin
  primary := TMPasAI_Raster.Create;
  second := TMPasAI_Raster.Create;
  while Play_Activted do
    begin
      r := TFFMPEG_Reader.Create(WhereFileFromConfigure('lady.mp4'));
      ...
      while Play_Activted and r.ReadFrame(
        TIF<TMPasAI_Raster>.Do_(primary_CheckBox.IsChecked, primary, nil),
        TIF<TMPasAI_Raster>.Do_(second_CheckBox.IsChecked, second, nil), True) do
        begin
          Critical.Lock;
