...
type
  ...
  TBasePass = class(TCore_Object_Intermediate)
  private
  ...
  TPolyPassManager = class(TCore_Object_Intermediate)
  private type
  ...
  TNavBio = class(TCore_InterfacedObject_Intermediate, IMovementEngineInterface)
  private
  ...
  public
    ...
    property MovementPath: TV2L read FMovementPath;
  ...
  TNavBioManager = class(TCore_Persistent_Intermediate)
  private
