...
type
  ...
  private
    ...
    function ReadFrame__(Stack_Num_: integer; primary_output, second_output: TMPasAI_Raster; RasterizationCopy_: Boolean): Boolean;
  public
    ...
    function ReadFrame(primary_output: TMPasAI_Raster; RasterizationCopy_: Boolean): Boolean; overload;
    function ReadFrame(primary_output, second_output: TMPasAI_Raster; RasterizationCopy_: Boolean): Boolean; overload;
...
function TFFMPEG_Reader.ReadFrame__(Stack_Num_: integer; primary_output, second_output: TMPasAI_Raster; RasterizationCopy_: Boolean): Boolean;
var
  done: Boolean;
  R: integer;
begin
...
function TFFMPEG_Reader.ReadFrame(primary_output: TMPasAI_Raster; RasterizationCopy_: Boolean): Boolean;
begin
  try
...
function TFFMPEG_Reader.ReadFrame(primary_output, second_output: TMPasAI_Raster; RasterizationCopy_: Boolean): Boolean;
begin
  try
