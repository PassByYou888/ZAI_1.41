...
type
  ...
  TPyramidCoorList = class(TCore_Object_Intermediate)
  private
    FList: TCore_List;
  ...
  TPyramidLayer = class(TCore_Object_Intermediate)
  private
  ...
  TPyramids = class(TCore_Object_Intermediate)
  private
  ...
  // feature on sift
  TFeature = class(TCore_Object_Intermediate)
  private const
    CPI2 = 2 * pi;
...
begin
  ...
  if pf1_len > pf2_len then
    begin
      TSwap<TLInt>.Do_(pf1_len, pf2_len);
      pf1 := dest;
      pf2 := Source;
    end
  else
