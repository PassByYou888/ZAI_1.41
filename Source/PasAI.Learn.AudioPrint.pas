...
begin
  case (FType) of
    0: Result := Filter0(Image, offset, FY, FWidth, FHeight, SubtractLog);
    1: Result := Filter1(Image, offset, FY, FWidth, FHeight, SubtractLog);
    2: Result := Filter2(Image, offset, FY, FWidth, FHeight, SubtractLog);
    3: Result := Filter3(Image, offset, FY, FWidth, FHeight, SubtractLog);
    4: Result := Filter4(Image, offset, FY, FWidth, FHeight, SubtractLog);
    5: Result := Filter5(Image, offset, FY, FWidth, FHeight, SubtractLog);
    else
      Result := 0.0;
  end;
end;
