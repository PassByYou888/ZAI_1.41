...
{$REGION 'Base Define'}
  ...
  TDSegmentionText_Draw_Info = TBigList<TDSegmentionText_Draw_>;
...
{$REGION 'Texture'}
  ...
  TDETexture_Pool_Decl = TBigList<TDETexture>;
...
{$REGION 'UI base'}
  ...
  TDrawEngine_UI_Pool_Decl = TBigList<TDrawEngine_UIBase>;
...
{$REGION 'Bullet'}
  ...
  TBullet_Pool_Decl = TBigList<TBullet_Base>;
...
{$REGION 'Sequence Animation'}
  TSequence_Animation_Base_Pool_Decl = TBigList<TSequenceAnimationBase>;
...
{$REGION 'Particle'}
  ...
  TParticles_Pool_Decl = TBigList<TParticles>;
  ...
  TParticle_Data_Pool = TBigList<TParticle_Data>;
...
{$REGION 'DrawEngine pool'}
  ...
  TDrawEngine_Pool_Data_List_Decl = TBigList<TDrawEngine_Pool_Data>;
...
{$REGION 'Text'}
  ...
  TScroll_Text_Data_Source_Pool_Decl = TBigList<TScroll_Text_Data_Source>;
...
{$REGION 'DrawEngine'}
  ...
  public
    ...
    { camera centre }
    function GetCamera_Centre: TDEVec;
    procedure SetCamera_Centre(const Value: TDEVec);
    property Camera_Centre: TDEVec read GetCamera_Centre write SetCamera_Centre;
    { camera box left-top }
    function GetCamera_LeftTop: TDEVec;
    procedure SetCamera_LeftTop(const Value: TDEVec);
    property Camera_LeftTop: TDEVec read GetCamera_LeftTop write SetCamera_LeftTop;
    { camera box right-bottom }
    function GetCamera_RightBottom: TDEVec;
    procedure SetCamera_RightBottom(const Value: TDEVec);
    property Camera_RightBottom: TDEVec read GetCamera_RightBottom write SetCamera_RightBottom;
    { camera scale }
    ...
    function Screen_Size_Vec: TDEVec;
    property Size_Vec: TDEVec read Screen_Size_Vec;
    function SceneWidth: TDEFloat;
    function SceneHeight: TDEFloat;
    function Scene_Size_Vec: TDEVec;
...
function TDrawEngine.GetCamera_Centre: TDEVec;
begin
  Result := ScreenCentreToScene;
end;

procedure TDrawEngine.SetCamera_Centre(const Value: TDEVec);
var
  siz: TDEVec;
  hf: TDEFloat;
begin
  siz := Vec2Mul(RectSize(CameraR), 0.5);
  CameraR := RectV2(Value[0] - siz[0], Value[1] - siz[1], Value[0] + siz[0], Value[1] + siz[1]);
end;

function TDrawEngine.GetCamera_LeftTop: TDEVec;
begin
  Result := ScreenToScene(0, 0);
end;

procedure TDrawEngine.SetCamera_LeftTop(const Value: TDEVec);
var
  siz: TDEVec;
begin
  siz := RectSize(CameraR);
  CameraR := RectV2(Value[0], Value[1], Value[0] + siz[0], Value[1] + siz[1]);
end;

function TDrawEngine.GetCamera_RightBottom: TDEVec;
begin
  Result := ScreenToScene(Width, Height);
end;

procedure TDrawEngine.SetCamera_RightBottom(const Value: TDEVec);
var
  siz: TDEVec;
begin
  siz := RectSize(CameraR);
  CameraR := RectV2(Value[0] - siz[0], Value[1] - siz[1], Value[0], Value[1]);
end;
...
function TDrawEngine.Screen_Size_Vec: TDEVec;
begin
  Result[0] := FWidth;
  Result[1] := FHeight;
end;
...
function TDrawEngine.Scene_Size_Vec: TDEVec;
begin
  Result[0] := Width / Scale;
  Result[1] := Height / Scale;
end;
...
PasAI.Core.OnCheckThreadSynchronize := DoCheckThreadSynchronize;
