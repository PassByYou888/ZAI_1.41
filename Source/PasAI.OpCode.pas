...
{$ENDIF FPC}
  PasAI.Core, PasAI.PascalStrings, PasAI.UPascalStrings, PasAI.MemoryStream, PasAI.Status, PasAI.ListEngine, PasAI.UnicodeMixedLib, PasAI.HashList.Templet, PasAI.Parsing;
...
uses PasAI.Geometry2D, PasAI.Geometry3D, PasAI.DFE, PasAI.Expression;
