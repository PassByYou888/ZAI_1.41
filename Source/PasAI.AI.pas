...
{$REGION 'BaseDefine'}
  ...
  PCutData = ^TCutData;
  TCutDataLineProcessor = TLine_2D_Templet<TCutDataType>;
  ...
  TSS_ProcessOnResult_C = procedure(Successed: Boolean; UserData: Pointer; SSOutput: TMPasAI_Raster; SSTokenOutput: TPascalStringList);
  TSS_ProcessOnResult_M = procedure(Successed: Boolean; UserData: Pointer; SSOutput: TMPasAI_Raster; SSTokenOutput: TPascalStringList) of object;

{$IFDEF FPC}
  TSS_ProcessOnResult_P = procedure(Successed: Boolean; UserData: Pointer; SSOutput: TMPasAI_Raster; SSTokenOutput: TPascalStringList) is nested;
{$ELSE FPC}
  TSS_ProcessOnResult_P = reference to procedure(Successed: Boolean; UserData: Pointer; SSOutput: TMPasAI_Raster; SSTokenOutput: TPascalStringList);
{$ENDIF FPC}
  ...
  TPas_AI_LogList_Decl = TGenericsList<TPas_AI_Log>;
...
{$REGION 'Machine Processor'}
  ...
  TMachine = class(TCore_Object_Intermediate)
  public
    AI: TPas_AI;
...
{$REGION 'API_Ptr'}
  ...
  TMorphExpIntf = class(TCore_Object_Intermediate)
  private
    FAI_EntryAPI: PAI_Core_API;
    MorphologyExpression_RegData: Pointer;
    function MorphExp_HotMap(OpRunTime: TOpCustomRunTime; OP_RT_Data: POpRTData; var Param: TOpParam): Variant;
    function MorphExp_JetMap(OpRunTime: TOpCustomRunTime; OP_RT_Data: POpRTData; var Param: TOpParam): Variant;
    function MorphExp_Salient(OpRunTime: TOpCustomRunTime; OP_RT_Data: POpRTData; var Param: TOpParam): Variant;
  ...
  TPas_AI_Core_API = packed record
    ...
    { Deep Residual Learning for Image Recognition, author Kaiming He, Xiangyu Zhang, Shaoqing Ren, Jian Sun }
...
{$REGION 'AI Core'}
  ...
  TPas_AI = class(TCore_Object_Intermediate)
{$REGION 'general'}
  protected
    { internal }
    FAI_EntryAPI: PAI_Core_API;
...
{$REGION 'MDNN-ResNet(ResNet metric DNN)'}
    ...
    class function BuildShareFaceLearn(): TLearn; overload;
    class procedure BuildShareFaceLearn(L: TLearn); overload;
    ...
    procedure Metric_ResNet_SaveToLearnEngine_DT(Metric_stream: TMS64; Snapshot_: Boolean; ThNum: Integer; RSeri: TPasAI_RasterSerialized; imgList: TPas_AI_ImageList; L: TLearn); overload;
    procedure Metric_ResNet_SaveToLearnEngine_DT(Metric_stream: TMS64; Snapshot_: Boolean; ThNum: Integer; RSeri: TPasAI_RasterSerialized; imgMat: TPas_AI_ImageMatrix; L: TLearn); overload;
    procedure Metric_ResNet_SaveToLearnEngine_DT(Metric_stream: TMS64; Snapshot_: Boolean; ThNum: Integer; imgList: TPas_AI_ImageList; L: TLearn); overload;
    procedure Metric_ResNet_SaveToLearnEngine_DT(Metric_stream: TMS64; Snapshot_: Boolean; ThNum: Integer; imgMat: TPas_AI_ImageMatrix; L: TLearn); overload;
    { normal }
...
{$REGION 'Large-Scale-LMDNN-ResNet(ResNet LMetric DNN)'}
    ...
    procedure LMetric_ResNet_SaveToLearnEngine_DT(LMetric_stream: TMS64; Snapshot_: Boolean; ThNum: Integer; RSeri: TPasAI_RasterSerialized; imgList: TPas_AI_ImageList; L: TLearn); overload;
    procedure LMetric_ResNet_SaveToLearnEngine_DT(LMetric_stream: TMS64; Snapshot_: Boolean; ThNum: Integer; RSeri: TPasAI_RasterSerialized; imgMat: TPas_AI_ImageMatrix; L: TLearn); overload;
    procedure LMetric_ResNet_SaveToLearnEngine_DT(LMetric_stream: TMS64; Snapshot_: Boolean; ThNum: Integer; imgList: TPas_AI_ImageList; L: TLearn); overload;
    procedure LMetric_ResNet_SaveToLearnEngine_DT(LMetric_stream: TMS64; Snapshot_: Boolean; ThNum: Integer; imgMat: TPas_AI_ImageMatrix; L: TLearn); overload;
    { normal }
...
{$REGION 'Convolutional Networks for Biomedical Image Segmentation'}
    (*
      ...
      hint: Max Classifier num is "C_SS_Classifier"
    *)
    { segmantic segmentation }
    ...
    function SS_Train(LargeScale_: Boolean; RSeri: TPasAI_RasterSerialized; imgList: TPas_AI_ImageList; Param: PSS_Train_Parameter; const SS_ColorPool: TSegmentationColorTable): Boolean; overload;
    function SS_Train(LargeScale_: Boolean; RSeri: TPasAI_RasterSerialized; imgMat: TPas_AI_ImageMatrix; Param: PSS_Train_Parameter; const SS_ColorPool: TSegmentationColorTable): Boolean; overload;
    function SS_Train_Stream(imgList: TPas_AI_ImageList; Param: PSS_Train_Parameter; const SS_ColorPool: TSegmentationColorTable): TMS64; overload;
    function SS_Train_Stream(imgMat: TPas_AI_ImageMatrix; Param: PSS_Train_Parameter; const SS_ColorPool: TSegmentationColorTable): TMS64; overload;
    ...
    function SS_Process(hnd: TSS_Handle; InputPasAI_Raster: TMPasAI_Raster; SS_ColorPool: TSegmentationColorTable; SSTokenOutput: TPascalStringList): TMPasAI_Raster;
    function SS_ProcessMatrix(hnd: TSS_Handle; mat_hnd: TMatrix_Image_Handle; Width, Height: Integer; SS_ColorPool: TSegmentationColorTable; SSTokenOutput: TPascalStringList): TMPasAI_Raster;
    procedure SS_ProcessAsync(hnd: TSS_Handle; SSInput: TMPasAI_Raster; SS_ColorPool: TSegmentationColorTable;
      UserData: Pointer; OnResultC: TSS_ProcessOnResult_C; OnResultM: TSS_ProcessOnResult_M; OnResultP: TSS_ProcessOnResult_P);
...
{$REGION 'correlation tracker'}
    ...
    function Tracker_Open_Matrix_Multi(parallel_: Boolean; ThNum: Integer; mat_hnd: TMatrix_Image_Handle; const track_rect: TArrayRectV2): TTracker_Handle_Array; overload;
    function Tracker_Open_Matrix_Multi(parallel_: Boolean; ThNum: Integer; mat_hnd: TMatrix_Image_Handle; const MMOD_Desc: TMMOD_Desc): TTracker_Handle_Array; overload;
    function Tracker_Open_Matrix_Multi(parallel_: Boolean; ThNum: Integer; mat_hnd: TMatrix_Image_Handle; const OD_Desc: TOD_Desc): TTracker_Handle_Array; overload;
    ...
    function Tracker_Update_Matrix_Multi(parallel_: Boolean; ThNum: Integer; hnd: TTracker_Handle_Array; mat_hnd: TMatrix_Image_Handle; var track_rect: TArrayRectV2): TLVec; overload;
    procedure Tracker_Update_Matrix_Multi(parallel_: Boolean; ThNum: Integer; hnd: TTracker_Handle_Array; mat_hnd: TMatrix_Image_Handle; var MMOD_Desc: TMMOD_Desc); overload;
    procedure Tracker_Update_Matrix_Multi(parallel_: Boolean; ThNum: Integer; hnd: TTracker_Handle_Array; mat_hnd: TMatrix_Image_Handle; var OD_Desc: TOD_Desc); overload;
    ...
    function Tracker_Open_RGB_Multi(parallel_: Boolean; ThNum: Integer; RGB_Hnd: TRGB_Image_Handle; const track_rect: TArrayRectV2): TTracker_Handle_Array; overload;
    function Tracker_Open_RGB_Multi(parallel_: Boolean; ThNum: Integer; RGB_Hnd: TRGB_Image_Handle; const MMOD_Desc: TMMOD_Desc): TTracker_Handle_Array; overload;
    function Tracker_Open_RGB_Multi(parallel_: Boolean; ThNum: Integer; RGB_Hnd: TRGB_Image_Handle; const OD_Desc: TOD_Desc): TTracker_Handle_Array; overload;
    ...
    function Tracker_Update_RGB_Multi(parallel_: Boolean; ThNum: Integer; hnd: TTracker_Handle_Array; RGB_Hnd: TRGB_Image_Handle; var track_rect: TArrayRectV2): TLVec; overload;
    procedure Tracker_Update_RGB_Multi(parallel_: Boolean; ThNum: Integer; hnd: TTracker_Handle_Array; RGB_Hnd: TRGB_Image_Handle; var MMOD_Desc: TMMOD_Desc); overload;
    procedure Tracker_Update_RGB_Multi(parallel_: Boolean; ThNum: Integer; hnd: TTracker_Handle_Array; RGB_Hnd: TRGB_Image_Handle; var OD_Desc: TOD_Desc); overload;
    ...
    function Tracker_Open_Multi(parallel_: Boolean; ThNum: Integer; Raster: TMPasAI_Raster; const track_rect: TArrayRectV2): TTracker_Handle_Array; overload;
    function Tracker_Open_Multi(parallel_: Boolean; ThNum: Integer; Raster: TMPasAI_Raster; const MMOD_Desc: TMMOD_Desc): TTracker_Handle_Array; overload;
    function Tracker_Open_Multi(parallel_: Boolean; ThNum: Integer; Raster: TMPasAI_Raster; const MMOD_DescArray: TMMOD_Desc_Array): TTracker_Handle_ArrayOfArray; overload;
    function Tracker_Open_Multi(parallel_: Boolean; ThNum: Integer; Raster: TMPasAI_Raster; const OD_Desc: TOD_Desc): TTracker_Handle_Array; overload;
    ...
    function Tracker_Update_Multi(parallel_: Boolean; ThNum: Integer; hnd: TTracker_Handle_Array; Raster: TMPasAI_Raster; var track_rect: TArrayRectV2): TLVec; overload;
    procedure Tracker_Update_Multi(parallel_: Boolean; ThNum: Integer; hnd: TTracker_Handle_Array; Raster: TMPasAI_Raster; var MMOD_Desc: TMMOD_Desc); overload;
    procedure Tracker_Update_Multi(parallel_: Boolean; ThNum: Integer; hnd: TTracker_Handle_ArrayOfArray; Raster: TMPasAI_Raster; var MMOD_DescArray: TMMOD_Desc_Array); overload;
    procedure Tracker_Update_Multi(parallel_: Boolean; ThNum: Integer; hnd: TTracker_Handle_Array; Raster: TMPasAI_Raster; var OD_Desc: TOD_Desc); overload;
...
{$ENDREGION 'ZMetric V1.0'}
  ...
  TSS_ResultProcessor = class(TCore_Object_Intermediate)
  private
    ...
    OnResultP: TSS_ProcessOnResult_P;
...
{$REGION 'TAI_DNN_Thread'}
  ...
  { event trigger queue }
  TPas_AI_DNN_Thread_Event_Trigger_Order = TCriticalOrderPtrStruct<TPas_AI_DNN_Thread_Trigger>;
  TAI_DNN_ThreadPool_ = TGenericsList<TPas_AI_DNN_Thread>;
  TPas_AI_Global_DNN_ThreadPool = TCritical_BigList<TPas_AI_DNN_Thread_Pool>;

  TPas_AI_DNN_Thread_Pool = class(TAI_DNN_ThreadPool_)
  private
  ...
  TPas_AI_DNN_Thread = class(TCore_Object_Intermediate)
  private
    FID: Integer;
    FAI: TPas_AI;
    FThread: TCompute;
...
{$ENDIF FPC}
  ...
  public
    ...
    procedure Open(train_file: SystemString);
    procedure Open_Stream(stream: TMS64);
    function Process(Input: TMPasAI_Raster; SS_ColorPool: TSegmentationColorTable; SSTokenOutput: TPascalStringList): TMPasAI_Raster;
    procedure ProcessC(UserData: Pointer; Input: TMPasAI_Raster; SS_ColorPool: TSegmentationColorTable; FreeInput: Boolean; OnResult: TPas_AI_DNN_Thread_SS_AsyncProcess_C);
    procedure ProcessM(UserData: Pointer; Input: TMPasAI_Raster; SS_ColorPool: TSegmentationColorTable; FreeInput: Boolean; OnResult: TPas_AI_DNN_Thread_SS_AsyncProcess_M);
    procedure ProcessP(UserData: Pointer; Input: TMPasAI_Raster; SS_ColorPool: TSegmentationColorTable; FreeInput: Boolean; OnResult: TPas_AI_DNN_Thread_SS_AsyncProcess_P);
  end;
...
{$REGION 'Parallel'}
  ...
  TPas_AI_Parallel_Decl = TGenericsList<TPas_AI>;
...
{$REGION 'IOProcessor'}
  ...
  TPas_AI_IO = class(TCore_InterfacedObject_Intermediate)
  public
  ...
  TPas_AI_IO_Buffer = TGenericsList<TPas_AI_IO>;

  TPas_AI_IO_Class = class of TPas_AI_IO;

  { async IO processor }
  TPas_AI_IO_Processor = class(TCore_InterfacedObject_Intermediate)
  private
    FAI: TPas_AI;
...
uses PasAI.Status, Math, PasAI.AI.Tech2022;
...
type
  TEntry_Cache_Pool = TString_Big_Hash_Pair_Pool<Pointer>;
        ...
        begin
          ...
          if detDef.Token.Len > 0 then
            begin
              LockObject(p^.L);
              try
                  p^.L.AddMemory(output, detDef.Token, PFormat('%d,%d,-1', [p^.imgData.Owner.ID, p^.imgData.ID]));
              except
              end;
              UnLockObject(p^.L);
            end;
          ...
          begin
            ...
            if Assigned(proc_init_ai_) then
              begin
                ...
                FAI_EntryAPI^.API_OnOneStep := API_OnOneStep;
                FAI_EntryAPI^.API_OnPause := API_OnPause;
                FAI_EntryAPI^.API_Status_Out := API_StatusIO_Out;
                FAI_EntryAPI^.API_GetTimeTick64 := API_GetTimeTick64;
                FAI_EntryAPI^.API_BuildString := API_BuildString;
                FAI_EntryAPI^.API_FreeString := API_FreeString;
                FAI_EntryAPI^.API_GetRaster := API_GetRaster;
                FAI_EntryAPI^.API_GetImage := API_GetImage;
                FAI_EntryAPI^.API_RecycleImage := API_RecycleImage;
                FAI_EntryAPI^.API_GetDetectorDefineNum := API_GetDetectorDefineNum;
                FAI_EntryAPI^.API_GetDetectorDefineImage := API_GetDetectorDefineImage;
                FAI_EntryAPI^.API_GetDetectorDefineRect := API_GetDetectorDefineRect;
                FAI_EntryAPI^.API_GetDetectorDefineLabel := API_GetDetectorDefineLabel;
                FAI_EntryAPI^.API_FreeDetectorDefineLabel := API_FreeDetectorDefineLabel;
                FAI_EntryAPI^.API_GetDetectorDefinePartNum := API_GetDetectorDefinePartNum;
                FAI_EntryAPI^.API_GetDetectorDefinePart := API_GetDetectorDefinePart;
                FAI_EntryAPI^.API_GetSegmentationMaskMergeImage := API_GetSegmentationMaskMergeImage;
                FAI_EntryAPI^.API_QuerySegmentationMaskColorID := API_QuerySegmentationMaskColorID;
                ...
                try
                  ...
                  if (FAI_EntryAPI^.MajorVer = 1) and (FAI_EntryAPI^.MinorVer = 41) and (FAI_EntryAPI^.VerMode = 3) and (FAI_EntryAPI^.VerID = 1) then
                    begin
                      ...
                      if (FAI_EntryAPI^.CheckKey() = 0) then
                        ...
                        begin
                          ...
                          FAI_EntryAPI^.MorphExpIntf.MorphologyExpression_RegData := RegMorphExpExternalAPI(nil, FAI_EntryAPI^.MorphExpIntf.RegMorphExpExternalAPI, nil);
...
type
  TSync_Load_ZAI_ = class(TCore_Object_Intermediate)
  public
...
begin
  ...
  if th.ThreadID = MainThreadProgress.ThreadID then
    ...
    begin
      ...
      TCompute.PostM1(sync.Sync_Load);
...
{$ENDIF initializationStatus}
  ...
  if AI_BuildIn_DBEngine.ItemOpen('/', 'Face_Classifier.SSL', itmHnd) then
    begin
      build_in_SSL_Face_Classifier_memory_Siz := itmHnd.Item.Size;
      p := GetMemory(build_in_SSL_Face_Classifier_memory_Siz);
      AI_BuildIn_DBEngine.ItemRead(itmHnd, build_in_SSL_Face_Classifier_memory_Siz, p^);
      AI_BuildIn_DBEngine.ItemClose(itmHnd);
      build_in_SSL_Face_Classifier_memory := p;
{$IFDEF initializationStatus}
      DoStatus('Z-AI "Face_Classifier.SSL" initialization done.');
{$ENDIF initializationStatus}
    end
  else
    begin
{$IFDEF initializationStatus}
      DoStatus('Z-AI buildIn "Face_Classifier.SSL" error.');
{$ENDIF initializationStatus}
    end;

  if AI_BuildIn_DBEngine.ItemOpen('/', 'BBC.SSL', itmHnd) then
    begin
      build_in_SSL_BBC_memory_Siz := itmHnd.Item.Size;
      p := GetMemory(build_in_SSL_BBC_memory_Siz);
      AI_BuildIn_DBEngine.ItemRead(itmHnd, build_in_SSL_BBC_memory_Siz, p^);
      AI_BuildIn_DBEngine.ItemClose(itmHnd);
      build_in_SSL_BBC_memory := p;
{$IFDEF initializationStatus}
      DoStatus('Z-AI "BBC.SSL" initialization done.');
{$ENDIF initializationStatus}
    end
  else
    begin
{$IFDEF initializationStatus}
      DoStatus('Z-AI buildIn "BBC.SSL" error.');
{$ENDIF initializationStatus}
    end;
...
begin
  ...
  build_in_SSL_Face_Classifier_memory := nil;
  build_in_SSL_Face_Classifier_memory_Siz := 0;
  build_in_SSL_BBC_memory := nil;
  build_in_SSL_BBC_memory_Siz := 0;

  found_build_in := TAtomBool.Create(True);
  done_build_in := TAtomBool.Create(False);

  TCompute.RunC(nil, nil, BuildIn_Thread_Run);
end;
...
begin
  ...
  for i := 0 to Length(desc) - 1 do
    begin
      p := L.Add(desc[i]);
      Box_Tool.Add_Box(RectV2(L[i].Left, L[i].Top, L[i].Right, L[i].Bottom), p, nil);
    end;
...
begin
  ...
  Box_Tool := TNearest_Box_Tool.Create;
  for i := 0 to Length(desc) - 1 do
    if not desc[i].Token.Same('ignore') then
      begin
        p := L.Add(desc[i]);
...
begin
  ...
  Param.SetDefaultValue('source', 'input' + PasAI.AI.Common.C_ImageList_Ext);
            ...
            try
              ...
              if outputstream <> nil then
                begin
                  ...
                  if (Param.GetDefaultValue('LearnVec', False) = True) and (AI.TrainingControl.stop = 0) then
                    begin
                      learnEng := TLearn.CreateClassifier(ltKDT, PasAI.AI.C_Metric_Dim);
                      ...
                      if Param.GetDefaultValue('DNNThread', False) = True then
                        begin
                          if umlMultipleMatch('*' + C_ImageMatrix_Ext, inputfile1) then
                              AI.Metric_ResNet_SaveToLearnEngine_DT(outputstream, Param.GetDefaultValue('Snapshot', False), Param.GetDefaultValue('LearnThreadNum', 4), inputImgMatrix, learnEng)
                          else
                              AI.Metric_ResNet_SaveToLearnEngine_DT(outputstream, Param.GetDefaultValue('Snapshot', False), Param.GetDefaultValue('LearnThreadNum', 4), inputImgList, learnEng);
                        end
                      else
                        begin
            ...
            try
              ...
              if outputstream <> nil then
                begin
                  ...
                  if (Param.GetDefaultValue('LearnVec', False) = True) and (AI.TrainingControl.stop = 0) then
                    begin
                      learnEng := TLearn.CreateClassifier(ltKDT, PasAI.AI.C_LMetric_Dim);
                      outputstream.Position := 0;
                      ...
                      if Param.GetDefaultValue('DNNThread', False) = True then
                        begin
                          if umlMultipleMatch('*' + C_ImageMatrix_Ext, inputfile1) then
                              AI.LMetric_ResNet_SaveToLearnEngine_DT(outputstream, Param.GetDefaultValue('Snapshot', False), Param.GetDefaultValue('LearnThreadNum', 4), inputImgMatrix, learnEng)
                          else
                              AI.LMetric_ResNet_SaveToLearnEngine_DT(outputstream, Param.GetDefaultValue('Snapshot', False), Param.GetDefaultValue('LearnThreadNum', 4), inputImgList, learnEng);
                        end
                      else
                        begin
...
begin
  ...
  if umlMultipleMatch(['TrainMRN', 'TrainingMRN', 'TrainMetricResNet'], ComputeFunc) then
    begin
        ...
        begin
          ...
          if Param.GetDefaultValue('DNNThread', False) = True then
            begin
              ...
              AI.Metric_ResNet_SaveToLearnEngine_DT(m64, Param.GetDefaultValue('Snapshot', False), Param.GetDefaultValue('LearnThreadNum', 4), RSeri, train_Img_Matrix, learnEng);
              DisposeObject(m64);
            end
          else
            begin
      ...
      if (Result) and (Param.GetDefaultValue('KDTreeVec', False) = True) and (AI.TrainingControl.stop = 0) then
        begin
          Metric_hnd := AI.Metric_ResNet_Open(OutputModel);
          DoStatus('build metric to Learn.KDTree');
          ...
          AI.Metric_ResNet_Close(Metric_hnd);
          DoStatus('process metric to Learn.KDTree done.');
          kd := TKDTree.Create(PasAI.AI.C_Metric_Dim);
          KD_Data.Build(kd);
    ...
    begin
        ...
        begin
          ...
          if Param.GetDefaultValue('DNNThread', False) = True then
            begin
              m64 := TMS64.Create;
              m64.LoadFromFile(OutputModel);
              AI.LMetric_ResNet_SaveToLearnEngine_DT(m64, Param.GetDefaultValue('Snapshot', False), Param.GetDefaultValue('LearnThreadNum', 4), RSeri, train_Img_Matrix, learnEng);
              DisposeObject(m64);
            end
          else
            begin
      ...
      if (Result) and (Param.GetDefaultValue('KDTreeVec', False) = True) and (AI.TrainingControl.stop = 0) then
        begin
          ...
          AI.LMetric_ResNet_Close(LMetric_hnd);
          DoStatus('process LMetric to Learn.KDTree done.');
          kd := TKDTree.Create(PasAI.AI.C_LMetric_Dim);
          KD_Data.Build(kd);
          DisposeObject(KD_Data);
          kd.SaveToFile(umlChangeFileExt(OutputModel, C_KDtree_Ext));
          DisposeObject(kd);
    ...
    begin
      ...
      Result := AI.ZMetric_Train(
        ...
        zmetric_param);
      TPas_AI.Free_ZMetric_Parameter(zmetric_param);
      if (Result) and (Param.GetDefaultValue('LearnVec', False) = True) and (AI.TrainingControl.stop = 0) then
        begin
          DoStatus('build Z-Metric to Learn.KDTree');
          learnEng := TPas_AI.Build_ZMetric_Learn;
      ...
      for j := 0 to img.DetectorDefineList.Count - 1 do
        begin
          ...
          if CalibrateDetectorDefine then
              detDef.R := R;
          DisposeObject(detDef.PrepareRaster);
          detDef.PrepareRaster := detDef.Owner.Raster.BuildAreaOffset_MinLoss_ScaleSpace(R, SS_Width, SS_Height);
        end;
    end;
end;
...
begin
  ...
  for i := 0 to imgList.Count - 1 do
    begin
      ...
      faceHnd := AI.Face_Detector(img.Raster, r_Desc, PasAI.AI.C_Metric_Input_Size);
      SetLength(r_Desc, 0);
      for j := 0 to img.DetectorDefineList.Count - 1 do
        begin
          detDef := img.DetectorDefineList[j];
    ...
    begin
      ...
      if mr <> nil then
        begin
          ...
          s.OnGetPixelSegClassify := DoGetPixelSegClassify;
        ...
        begin
          ...
          if (detDef.PrepareRaster <> nil) and (not detDef.PrepareRaster.Empty) then
            begin
              ...
              tmp := detDef.Owner.Raster.BuildAreaOffset_MinLoss_ScaleSpace(detDef.R, C_Metric_Input_Size, C_Metric_Input_Size);
        ...
        begin
          ...
          if (detDef.PrepareRaster <> nil) and (not detDef.PrepareRaster.Empty) then
            begin
              ...
              tmp := detDef.Owner.Raster.BuildAreaOffset_MinLoss_ScaleSpace(detDef.R, C_LMetric_Input_Size, C_LMetric_Input_Size);
        ...
        begin
          ...
          if (detDef.PrepareRaster <> nil) and (not detDef.PrepareRaster.Empty) then
            begin
              ...
              tmp := detDef.Owner.Raster.BuildAreaOffset_MinLoss_ScaleSpace(detDef.R, SS_Width, SS_Height);
...
function TMorphExpIntf.MorphExp_HotMap(OpRunTime: TOpCustomRunTime; OP_RT_Data: POpRTData; var Param: TOpParam): Variant;
var
...
function TMorphExpIntf.MorphExp_JetMap(OpRunTime: TOpCustomRunTime; OP_RT_Data: POpRTData; var Param: TOpParam): Variant;
var
  meRT: TMorphExpRunTime;
begin
  meRT := OpRunTime as TMorphExpRunTime;
...
function TMorphExpIntf.MorphExp_Salient(OpRunTime: TOpCustomRunTime; OP_RT_Data: POpRTData; var Param: TOpParam): Variant;
var
  meRT: TMorphExpRunTime;
begin
  meRT := OpRunTime as TMorphExpRunTime;
...
var
  prefix: U_String;
begin
  Exp.Reg_RT_OpM('HotMap', 'HotMap(): build Hot rastermization', MorphExp_HotMap)^.Category := 'Z-AI Engine';
  Exp.Reg_RT_OpM('JetMap', 'JetMap(): build Hot rastermization', MorphExp_JetMap)^.Category := 'Z-AI Engine';
  Exp.Reg_RT_OpM('Salient', 'Salient(): build Salient rastermization', MorphExp_Salient)^.Category := 'Z-AI Engine';

  prefix := umlChangeFileExt(umlGetFileName(FAI_EntryAPI^.LibraryFile), '') + '_';
  prefix := prefix.ReplaceChar('.', '_');
  Exp.Reg_RT_OpM(prefix.Text + 'HotMap', prefix.Text + 'HotMap(): build Hot rastermization', MorphExp_HotMap)^.Category := 'Z-AI Engine';
  Exp.Reg_RT_OpM(prefix.Text + 'JetMap', prefix.Text + 'JetMap(): build Hot rastermization', MorphExp_JetMap)^.Category := 'Z-AI Engine';
  Exp.Reg_RT_OpM(prefix.Text + 'Salient', prefix.Text + 'Salient(): build Salient rastermization', MorphExp_Salient)^.Category := 'Z-AI Engine';
end;
...
begin
  ...
  cutData := GetMemory(L);
  FillPtr(cutData, L, PasAI.AI.C_CUT_BGD);
  ...
  bin := CutRaster(Raster, cutData, box, 1, PasAI.AI.C_CUT_MODE_INIT_WITH_RECT);
...
begin
  ...
  if sd1_len > sd2_len then
    begin
      TSwap<Integer>.Do_(sd1_len, sd2_len);
      SD1 := sd2_;
      R1 := r2_;
      SD2 := sd1_;
      R2 := r1_;
...
begin
  ...
  for i := 0 to Length(desc) - 1 do
      fixed_desc[i] := AIRect(MinLoss_RectScaleSpace(RectV2(desc[i]), extract_face_size, extract_face_size));
...
class procedure TPas_AI.BuildShareFaceLearn(L: TLearn);
var
  m64: TMS64;
begin
  Wait_AI_Init;
...
var
  L: TLearn;
begin
  L := TLearn.CreateClassifier(ltKDT, PasAI.AI.C_Metric_Dim);
  Result := L;
end;
...
begin
  Result := '';
  MinK_ := 0;
  if Length(Input_) <> PasAI.AI.C_Metric_Dim then
      exit;
          ...
          if (RasterArray[i].Width <> C_Metric_Input_Size) or (RasterArray[i].Height <> C_Metric_Input_Size) then
            begin
              ...
              RasterArray[i].ProjectionTo(nr,
                TV2Rect4.Init(MinLoss_Rect(C_Metric_Input_Size, C_Metric_Input_Size, RasterArray[i].BoundsRectV2), 0),
    ...
    begin
      ...
      if Snapshot_ then
        begin
          ...
          p^.imgData := imgData;
          p^.detDef := nil;
          TPas_AI_DNN_Thread_Metric(Pool_.MinLoad_DNN_Thread).ProcessC(p, imgData.Raster.Clone, True, Metric_ResNet_SaveToLearnEngine_DT_Backcall);
        end
      else
            ...
            if detDef.Token.Len > 0 then
              begin
                ...
                if detDef.PrepareRaster.Empty then
                    ...
                    detDef.Owner.Raster.BuildAreaOffset_MinLoss_ScaleSpace(detDef.R, C_Metric_Input_Size, C_Metric_Input_Size),
                    True, Metric_ResNet_SaveToLearnEngine_DT_Backcall)
                else
                    TPas_AI_DNN_Thread_Metric(Pool_.MinLoad_DNN_Thread).ProcessC(p,
...
procedure TPas_AI.Metric_ResNet_SaveToLearnEngine_DT(Metric_stream: TMS64; Snapshot_: Boolean; ThNum: Integer; RSeri: TPasAI_RasterSerialized; imgList: TPas_AI_ImageList; L: TLearn);
var
...
begin
  ...
  for i in Device_ do
      Pool_.BuildDeviceThread(FAI_EntryAPI, i, ThNum, TPas_AI_DNN_Thread_Metric);
...
procedure TPas_AI.Metric_ResNet_SaveToLearnEngine_DT(Metric_stream: TMS64; Snapshot_: Boolean; ThNum: Integer; RSeri: TPasAI_RasterSerialized; imgMat: TPas_AI_ImageMatrix; L: TLearn);
var
  Pool_: TPas_AI_DNN_Thread_Pool;
  i: Integer;
  Device_: TLIVec;
...
procedure TPas_AI.Metric_ResNet_SaveToLearnEngine_DT(Metric_stream: TMS64; Snapshot_: Boolean; ThNum: Integer; imgList: TPas_AI_ImageList; L: TLearn);
begin
  Metric_ResNet_SaveToLearnEngine_DT(Metric_stream, Snapshot_, ThNum, nil, imgList, L);
end;

procedure TPas_AI.Metric_ResNet_SaveToLearnEngine_DT(Metric_stream: TMS64; Snapshot_: Boolean; ThNum: Integer; imgMat: TPas_AI_ImageMatrix; L: TLearn);
begin
  Metric_ResNet_SaveToLearnEngine_DT(Metric_stream, Snapshot_, ThNum, nil, imgMat, L);
end;
            ...
            begin
              for j := 0 to imgData.DetectorDefineList.Count - 1 do
                begin
                  detDef := imgData.DetectorDefineList[j];
                  if detDef.Token.Len > 0 then
                      L.AddMemory(V, detDef.Token, PFormat('%d,%d,-1', [imgData.Owner.ID, imgData.ID]));
                end;
            end;
        end
      else
          ...
          begin
            ...
            if detDef.Token.Len > 0 then
              begin
                if detDef.PrepareRaster.Empty then
                  begin
                    mr := detDef.Owner.Raster.BuildAreaOffset_MinLoss_ScaleSpace(detDef.R, C_Metric_Input_Size, C_Metric_Input_Size);
                    V := Metric_ResNet_Process(Metric_hnd, mr);
                    DisposeObject(mr);
                  end
                else
                ...
                if Length(V) <> C_Metric_Dim then
                    ...
                    L.AddMemory(V, detDef.Token, PFormat('%d,%d,%d', [detDef.Owner.Owner.ID, detDef.Owner.ID, detDef.Owner.DetectorDefineList.IndexOf(detDef)]));
              end;
          end;
      if RSeri <> nil then
          imgData.SerializedAndRecycleMemory(RSeri);
...
var
  L: TLearn;
begin
  L := TLearn.CreateClassifier(ltKDT, PasAI.AI.C_LMetric_Dim);
  Result := L;
end;
...
begin
  Result := '';
  MinK_ := 0;
  if Length(Input_) <> PasAI.AI.C_LMetric_Dim then
      exit;
  hPool := L_.ProcessMaxIndexCandidate_Pool(Input_, Filter_Min_, Filter_Max_);
  pool := hPool.Get_Min_Mean_Pool;
  if pool <> nil then
        ...
        begin
          ...
          if (RasterArray[i].Width <> C_LMetric_Input_Size) or (RasterArray[i].Height <> C_LMetric_Input_Size) then
            begin
              ...
              RasterArray[i].ProjectionTo(nr,
                TV2Rect4.Init(MinLoss_Rect(C_LMetric_Input_Size, C_LMetric_Input_Size, RasterArray[i].BoundsRectV2), 0),
                TV2Rect4.Init(nr.BoundsRectV2, 0),
                True, 1.0);
            end
          else { fast assign }
    ...
    begin
      ...
      if Snapshot_ then
        begin
          ...
          p^.imgData := imgData;
          p^.detDef := nil;
          TPas_AI_DNN_Thread_LMetric(Pool_.MinLoad_DNN_Thread).ProcessC(p, imgData.Raster.Clone, True, LMetric_ResNet_SaveToLearnEngine_DT_Backcall);
        end
      else
        for j := 0 to imgData.DetectorDefineList.Count - 1 do
          begin
            ...
            if detDef.Token.Len > 0 then
              begin
                ...
                if detDef.PrepareRaster.Empty then
                    TPas_AI_DNN_Thread_LMetric(Pool_.MinLoad_DNN_Thread).ProcessC(p, detDef.Owner.Raster.BuildAreaOffset_MinLoss_ScaleSpace(detDef.R, C_LMetric_Input_Size, C_LMetric_Input_Size),
                    True, LMetric_ResNet_SaveToLearnEngine_DT_Backcall)
                else
                    TPas_AI_DNN_Thread_LMetric(Pool_.MinLoad_DNN_Thread).ProcessC(p, detDef.PrepareRaster.Clone, True, LMetric_ResNet_SaveToLearnEngine_DT_Backcall);
              end;
          end;
      if RSeri <> nil then
          imgData.SerializedAndRecycleMemory(RSeri);
...
procedure TPas_AI.LMetric_ResNet_SaveToLearnEngine_DT(LMetric_stream: TMS64; Snapshot_: Boolean; ThNum: Integer; RSeri: TPasAI_RasterSerialized; imgList: TPas_AI_ImageList; L: TLearn);
var
  Pool_: TPas_AI_DNN_Thread_Pool;
  i: Integer;
  Device_: TLIVec;
begin
  ...
  GetComputeDeviceOfTraining(Device_);
  for i in Device_ do
      Pool_.BuildDeviceThread(FAI_EntryAPI, i, ThNum, TPas_AI_DNN_Thread_LMetric);
...
procedure TPas_AI.LMetric_ResNet_SaveToLearnEngine_DT(LMetric_stream: TMS64; Snapshot_: Boolean; ThNum: Integer; RSeri: TPasAI_RasterSerialized; imgMat: TPas_AI_ImageMatrix; L: TLearn);
var
  Pool_: TPas_AI_DNN_Thread_Pool;
  i: Integer;
  Device_: TLIVec;
...
procedure TPas_AI.LMetric_ResNet_SaveToLearnEngine_DT(LMetric_stream: TMS64; Snapshot_: Boolean; ThNum: Integer; imgList: TPas_AI_ImageList; L: TLearn);
begin
  LMetric_ResNet_SaveToLearnEngine_DT(LMetric_stream, Snapshot_, ThNum, nil, imgList, L);
end;

procedure TPas_AI.LMetric_ResNet_SaveToLearnEngine_DT(LMetric_stream: TMS64; Snapshot_: Boolean; ThNum: Integer; imgMat: TPas_AI_ImageMatrix; L: TLearn);
begin
  LMetric_ResNet_SaveToLearnEngine_DT(LMetric_stream, Snapshot_, ThNum, nil, imgMat, L);
end;
          ...
          begin
            ...
            if detDef.Token.Len > 0 then
              begin
                if detDef.PrepareRaster.Empty then
                  begin
                    mr := detDef.Owner.Raster.BuildAreaOffset_MinLoss_ScaleSpace(detDef.R, C_LMetric_Input_Size, C_LMetric_Input_Size);
                    V := LMetric_ResNet_Process(LMetric_hnd, mr);
                    DisposeObject(mr);
                  end
                else
...
var
  ...
  i: Integer;
begin
  imgList.Remove_Null_Detector_Define_Image(True);
  Result := -1;
...
var
  ...
  i: Integer;
begin
  imgMat.Remove_Null_Detector_Define_Image(True);
  Result := -1;
  imgL := imgMat.ImageList();
  ...
  if (Raster.Width <> SS_Width) or (Raster.Height <> SS_Height) then
    begin
      ...
      Raster.ProjectionTo(nr,
        TV2Rect4.Init(MinLoss_Rect(SS_Width, SS_Height, Raster.BoundsRectV2), 0),
        TV2Rect4.Init(nr.BoundsRectV2, 0),
        True, 1.0);
    end
  else
...
function TPas_AI.SS_Train(LargeScale_: Boolean; RSeri: TPasAI_RasterSerialized; imgList: TPas_AI_ImageList; Param: PSS_Train_Parameter; const SS_ColorPool: TSegmentationColorTable): Boolean;
var
  tk: TTimeTick;
  i: Integer;
  List: TAI_Image_List_;
...
begin
  ...
  tk := GetTimeTick();
  if LargeScale_ then
      imgList.LargeScale_BuildMaskMerge(RSeri, SS_ColorPool)
  else
      imgList.BuildMaskMerge(SS_ColorPool);
...
function TPas_AI.SS_Train(LargeScale_: Boolean; RSeri: TPasAI_RasterSerialized; imgMat: TPas_AI_ImageMatrix; Param: PSS_Train_Parameter; const SS_ColorPool: TSegmentationColorTable): Boolean;
var
  tk: TTimeTick;
  i, j: Integer;
  List: TAI_Image_List_;
...
begin
  ...
  if LargeScale_ then
      imgMat.LargeScale_BuildMaskMerge(RSeri, SS_ColorPool)
  else
      imgMat.BuildMaskMerge(SS_ColorPool);
...
function TPas_AI.SS_Train_Stream(imgList: TPas_AI_ImageList; Param: PSS_Train_Parameter; const SS_ColorPool: TSegmentationColorTable): TMS64;
var
  fn: U_String;
begin
  Result := nil;

  if SS_Train(False, nil, imgList, Param, SS_ColorPool) then
    begin
      fn := Get_P_Bytes_String(Param^.train_output);
      if umlFileExists(fn) then
        begin
...
function TPas_AI.SS_Train_Stream(imgMat: TPas_AI_ImageMatrix; Param: PSS_Train_Parameter; const SS_ColorPool: TSegmentationColorTable): TMS64;
var
  fn: U_String;
begin
  Result := nil;

  if SS_Train(False, nil, imgMat, Param, SS_ColorPool) then
    begin
      fn := Get_P_Bytes_String(Param^.train_output);
      if umlFileExists(fn) then
        begin
...
function TPas_AI.SS_Process(hnd: TSS_Handle; InputPasAI_Raster: TMPasAI_Raster; SS_ColorPool: TSegmentationColorTable; SSTokenOutput: TPascalStringList): TMPasAI_Raster;
type
  TColor_Data = record
    Found: Boolean;
    color: TRColor;
...
var
  ...
  p: PWORD;
  tk: U_String;
  Color_Buff: array of TColor_Data;
begin
  ...
  if FAI_EntryAPI^.SS_Process(hnd, InputPasAI_Raster.Bits, InputPasAI_Raster.Width, InputPasAI_Raster.Height, @SSMatrix[0]) >= 0 then
    begin
      ...
      SetLength(Color_Buff, $FFFF);
      for pass := 0 to dr.Height - 1 do
        begin
          p := @SSMatrix[pass * InputPasAI_Raster.Width];
          for i := 0 to dr.Width - 1 do
            begin
              if SS_ColorPool = nil then
                  dr.FastPixel[i, pass] := SS_TranslateColor(p^).BGRA
              else if Color_Buff[p^].Found then
                begin
                  dr.FastPixel[i, pass] := Color_Buff[p^].color;
                end
              else if SS_ColorPool.GetIDColorAndToken(p^, RColor(0, 0, 0, $FF), '', Color_Buff[p^].color, tk) then
                begin
                  Color_Buff[p^].Found := True;
                  dr.FastPixel[i, pass] := Color_Buff[p^].color;
                  if SSTokenOutput <> nil then
                      SSTokenOutput.Append(tk);
                end;
              inc(p);
            end;
        end;
      SetLength(Color_Buff, 0);
      Result := dr;
    end;
...
function TPas_AI.SS_ProcessMatrix(hnd: TSS_Handle; mat_hnd: TMatrix_Image_Handle; Width, Height: Integer; SS_ColorPool: TSegmentationColorTable; SSTokenOutput: TPascalStringList): TMPasAI_Raster;
type
  TColor_Data = record
    Found: Boolean;
    color: TRColor;
...
procedure TPas_AI.SS_ProcessAsync(hnd: TSS_Handle; SSInput: TMPasAI_Raster; SS_ColorPool: TSegmentationColorTable;
UserData: Pointer; OnResultC: TSS_ProcessOnResult_C; OnResultM: TSS_ProcessOnResult_M; OnResultP: TSS_ProcessOnResult_P);
var
...
begin
  ...
  ResultData.SSOutput := TMPasAI_Raster.Create;
  ResultData.SSOutput.SetSize(SSInput.Width, SSInput.Height);
  ResultData.SS_ColorPool := SS_ColorPool;
  ...
  if FAI_EntryAPI^.SS_Process(hnd, SSInput.Bits, SSInput.Width, SSInput.Height, @ResultData.SSMatrix[0]) >= 0 then
    begin
      TCompute.RunM(nil, nil, ResultData.ThRun);
    end
  else
    begin
      ResultData.DoFailed();
...
function TPas_AI.Tracker_Open_Matrix_Multi(parallel_: Boolean; ThNum: Integer; mat_hnd: TMatrix_Image_Handle; const track_rect: TArrayRectV2): TTracker_Handle_Array;
var
  buff: TTracker_Handle_Array;
...
begin
  SetLength(buff, Length(track_rect));
{$IFDEF FPC}
  FPCParallelFor(ThNum, parallel_, 0, Length(track_rect) - 1, Nested_ParallelFor);
{$ELSE FPC}
  DelphiParallelFor(ThNum, parallel_, 0, Length(track_rect) - 1, procedure(pass: Integer)
    begin
      buff[pass] := Tracker_Open_Matrix(mat_hnd, track_rect[pass]);
    end);
{$ENDIF FPC}
...
function TPas_AI.Tracker_Open_Matrix_Multi(parallel_: Boolean; ThNum: Integer; mat_hnd: TMatrix_Image_Handle; const MMOD_Desc: TMMOD_Desc): TTracker_Handle_Array;
var
  buff: TTracker_Handle_Array;
...
begin
  SetLength(buff, Length(MMOD_Desc));
{$IFDEF FPC}
  FPCParallelFor(ThNum, parallel_, 0, Length(MMOD_Desc) - 1, Nested_ParallelFor);
{$ELSE FPC}
  DelphiParallelFor(ThNum, parallel_, 0, Length(MMOD_Desc) - 1, procedure(pass: Integer)
    begin
      buff[pass] := Tracker_Open_Matrix(mat_hnd, MMOD_Desc[pass].R);
    end);
{$ENDIF FPC}
...
function TPas_AI.Tracker_Open_Matrix_Multi(parallel_: Boolean; ThNum: Integer; mat_hnd: TMatrix_Image_Handle; const OD_Desc: TOD_Desc): TTracker_Handle_Array;
var
  buff: TTracker_Handle_Array;
...
begin
  SetLength(buff, Length(OD_Desc));
{$IFDEF FPC}
  FPCParallelFor(ThNum, parallel_, 0, Length(OD_Desc) - 1, Nested_ParallelFor);
{$ELSE FPC}
  DelphiParallelFor(ThNum, parallel_, 0, Length(OD_Desc) - 1, procedure(pass: Integer)
    begin
      buff[pass] := Tracker_Open_Matrix(mat_hnd, RectV2(OD_Desc[pass]));
    end);
{$ENDIF FPC}
...
function TPas_AI.Tracker_Update_Matrix_Multi(parallel_: Boolean; ThNum: Integer; hnd: TTracker_Handle_Array; mat_hnd: TMatrix_Image_Handle; var track_rect: TArrayRectV2): TLVec;
var
  buff: TArrayRectV2;
  R_: TLVec;
{$IFDEF FPC}
...
procedure TPas_AI.Tracker_Update_Matrix_Multi(parallel_: Boolean; ThNum: Integer; hnd: TTracker_Handle_Array; mat_hnd: TMatrix_Image_Handle; var MMOD_Desc: TMMOD_Desc);
var
  buff: TMMOD_Desc;
{$IFDEF FPC}
  procedure Nested_ParallelFor(pass: Integer);
...
procedure TPas_AI.Tracker_Update_Matrix_Multi(parallel_: Boolean; ThNum: Integer; hnd: TTracker_Handle_Array; mat_hnd: TMatrix_Image_Handle; var OD_Desc: TOD_Desc);
var
  buff: TOD_Desc;
{$IFDEF FPC}
  procedure Nested_ParallelFor(pass: Integer);
...
function TPas_AI.Tracker_Open_RGB_Multi(parallel_: Boolean; ThNum: Integer; RGB_Hnd: TRGB_Image_Handle; const track_rect: TArrayRectV2): TTracker_Handle_Array;
var
  buff: TTracker_Handle_Array;
...
function TPas_AI.Tracker_Open_RGB_Multi(parallel_: Boolean; ThNum: Integer; RGB_Hnd: TRGB_Image_Handle; const MMOD_Desc: TMMOD_Desc): TTracker_Handle_Array;
var
  buff: TTracker_Handle_Array;
...
function TPas_AI.Tracker_Open_RGB_Multi(parallel_: Boolean; ThNum: Integer; RGB_Hnd: TRGB_Image_Handle; const OD_Desc: TOD_Desc): TTracker_Handle_Array;
var
  buff: TTracker_Handle_Array;
...
function TPas_AI.Tracker_Update_RGB_Multi(parallel_: Boolean; ThNum: Integer; hnd: TTracker_Handle_Array; RGB_Hnd: TRGB_Image_Handle; var track_rect: TArrayRectV2): TLVec;
var
  buff: TArrayRectV2;
  R_: TLVec;
{$IFDEF FPC}
...
procedure TPas_AI.Tracker_Update_RGB_Multi(parallel_: Boolean; ThNum: Integer; hnd: TTracker_Handle_Array; RGB_Hnd: TRGB_Image_Handle; var MMOD_Desc: TMMOD_Desc);
var
  buff: TMMOD_Desc;
{$IFDEF FPC}
  procedure Nested_ParallelFor(pass: Integer);
...
procedure TPas_AI.Tracker_Update_RGB_Multi(parallel_: Boolean; ThNum: Integer; hnd: TTracker_Handle_Array; RGB_Hnd: TRGB_Image_Handle; var OD_Desc: TOD_Desc);
var
  buff: TOD_Desc;
{$IFDEF FPC}
  procedure Nested_ParallelFor(pass: Integer);
...
function TPas_AI.Tracker_Open_Multi(parallel_: Boolean; ThNum: Integer; Raster: TMPasAI_Raster; const track_rect: TArrayRectV2): TTracker_Handle_Array;
var
  RGB_Hnd: TRGB_Image_Handle;
begin
  SetLength(Result, 0);
  ...
  if RGB_Hnd = nil then
      exit;
  Result := Tracker_Open_RGB_Multi(parallel_, ThNum, RGB_Hnd, track_rect);
  Close_RGB_Image(RGB_Hnd);
end;

function TPas_AI.Tracker_Open_Multi(parallel_: Boolean; ThNum: Integer; Raster: TMPasAI_Raster; const MMOD_Desc: TMMOD_Desc): TTracker_Handle_Array;
var
  RGB_Hnd: TRGB_Image_Handle;
begin
  SetLength(Result, 0);
  ...
  if RGB_Hnd = nil then
      exit;
  Result := Tracker_Open_RGB_Multi(parallel_, ThNum, RGB_Hnd, MMOD_Desc);
  Close_RGB_Image(RGB_Hnd);
end;

function TPas_AI.Tracker_Open_Multi(parallel_: Boolean; ThNum: Integer; Raster: TMPasAI_Raster; const MMOD_DescArray: TMMOD_Desc_Array): TTracker_Handle_ArrayOfArray;
var
  RGB_Hnd: TRGB_Image_Handle;
  buff: TTracker_Handle_ArrayOfArray;
{$IFDEF FPC}
...
{$IFDEF FPC}
  FPCParallelFor(ThNum, parallel_, 0, Length(MMOD_DescArray) - 1, Nested_ParallelFor);
{$ELSE FPC}
  DelphiParallelFor(ThNum, parallel_, 0, Length(MMOD_DescArray) - 1, procedure(pass: Integer)
    begin
      buff[pass] := Tracker_Open_RGB_Multi(parallel_, RGB_Hnd, MMOD_DescArray[pass]);
    end);
{$ENDIF FPC}
...
function TPas_AI.Tracker_Open_Multi(parallel_: Boolean; ThNum: Integer; Raster: TMPasAI_Raster; const OD_Desc: TOD_Desc): TTracker_Handle_Array;
var
  RGB_Hnd: TRGB_Image_Handle;
begin
  SetLength(Result, 0);
  ...
  if RGB_Hnd = nil then
      exit;
  Result := Tracker_Open_RGB_Multi(parallel_, ThNum, RGB_Hnd, OD_Desc);
  Close_RGB_Image(RGB_Hnd);
end;
...
function TPas_AI.Tracker_Update_Multi(parallel_: Boolean; ThNum: Integer; hnd: TTracker_Handle_Array; Raster: TMPasAI_Raster; var track_rect: TArrayRectV2): TLVec;
var
  RGB_Hnd: TRGB_Image_Handle;
begin
  SetLength(Result, 0);
  ...
  if RGB_Hnd = nil then
      exit;
  Result := Tracker_Update_RGB_Multi(parallel_, ThNum, hnd, RGB_Hnd, track_rect);
  Close_RGB_Image(RGB_Hnd);
end;

procedure TPas_AI.Tracker_Update_Multi(parallel_: Boolean; ThNum: Integer; hnd: TTracker_Handle_Array; Raster: TMPasAI_Raster; var MMOD_Desc: TMMOD_Desc);
var
  RGB_Hnd: TRGB_Image_Handle;
begin
  if (FAI_EntryAPI = nil) then
  ...
  if RGB_Hnd = nil then
      exit;
  Tracker_Update_RGB_Multi(parallel_, ThNum, hnd, RGB_Hnd, MMOD_Desc);
  Close_RGB_Image(RGB_Hnd);
end;

procedure TPas_AI.Tracker_Update_Multi(parallel_: Boolean; ThNum: Integer; hnd: TTracker_Handle_ArrayOfArray; Raster: TMPasAI_Raster; var MMOD_DescArray: TMMOD_Desc_Array);
var
  RGB_Hnd: TRGB_Image_Handle;
  buff: TMMOD_Desc_Array;
{$IFDEF FPC}
...
procedure TPas_AI.Tracker_Update_Multi(parallel_: Boolean; ThNum: Integer; hnd: TTracker_Handle_Array; Raster: TMPasAI_Raster; var OD_Desc: TOD_Desc);
var
  RGB_Hnd: TRGB_Image_Handle;
begin
  if (FAI_EntryAPI = nil) then
  ...
  if RGB_Hnd = nil then
      exit;
  Tracker_Update_RGB_Multi(parallel_, ThNum, hnd, RGB_Hnd, OD_Desc);
  Close_RGB_Image(RGB_Hnd);
end;
...
begin
  ...
  if not Assigned(FAI_EntryAPI^.ProcessOCR) then
      exit;
  m64 := TMS64.Create;
  tmp := Raster.FitScaleAsNew(1500, 1500);
...
var
  L: TLearn;
begin
  L := TLearn.CreateClassifier(ltKDT, PasAI.AI.C_ZMetric_Dim);
  Result := L;
end;
...
begin
  Result := '';
  MinK_ := 0;
  if Length(Input_) <> PasAI.AI.C_ZMetric_Dim then
      exit;
  hPool := L_.ProcessMaxIndexCandidate_Pool(Input_, Filter_Min_, Filter_Max_);
  pool := hPool.Get_Min_Mean_Pool;
  if pool <> nil then
        ...
        begin
          ...
          if (RasterArray[i].Width <> SS_Width) or (RasterArray[i].Height <> SS_Height) then
            begin
              nr.SetSize(SS_Width, SS_Height);
              RasterArray[i].ProjectionTo(nr,
                TV2Rect4.Init(MinLoss_Rect(SS_Width, SS_Height, RasterArray[i].BoundsRectV2), 0),
                TV2Rect4.Init(nr.BoundsRectV2, 0),
                True, 1.0);
            end
          else { fast assign }
    ...
    begin
      ...
      if Snapshot_ then
        begin
          ...
          p^.imgData := imgData;
          p^.detDef := nil;
          TPas_AI_DNN_Thread_ZMetric(Pool_.MinLoad_DNN_Thread).ProcessC(p, imgData.Raster.Clone, SS_Width, SS_Height, True, ZMetric_SaveToLearnEngine_DT_Backcall);
        end
      else
        for j := 0 to imgData.DetectorDefineList.Count - 1 do
          begin
            ...
            if detDef.Token.Len > 0 then
              begin
                ...
                if detDef.PrepareRaster.Empty then
                    ...
                    detDef.Owner.Raster.BuildAreaOffset_MinLoss_ScaleSpace(detDef.R, C_Metric_Input_Size, C_Metric_Input_Size),
                    SS_Width, SS_Height, True, ZMetric_SaveToLearnEngine_DT_Backcall)
                else
                    TPas_AI_DNN_Thread_ZMetric(Pool_.MinLoad_DNN_Thread).ProcessC(p,
                    detDef.PrepareRaster.Clone,
                    SS_Width, SS_Height, True, ZMetric_SaveToLearnEngine_DT_Backcall);
...
begin
  if Assigned(OnResultC) then
      OnResultC(False, UserData, nil, nil)
  else if Assigned(OnResultM) then
      OnResultM(False, UserData, nil, nil)
  else if Assigned(OnResultP) then
      OnResultP(False, UserData, nil, nil);
end;

procedure TSS_ResultProcessor.DoSuccessed;
begin
  if Assigned(OnResultC) then
      OnResultC(True, UserData, SSOutput, SSTokenOutput)
  else if Assigned(OnResultM) then
      OnResultM(True, UserData, SSOutput, SSTokenOutput)
  else if Assigned(OnResultP) then
      OnResultP(True, UserData, SSOutput, SSTokenOutput);
end;
  ...
  for pass := 0 to SSOutput.Height - 1 do
    begin
      ...
      for i := 0 to SSOutput.Width - 1 do
        begin
          if SS_ColorPool = nil then
              SSOutput.FastPixel[i, pass] := TPas_AI.SS_TranslateColor(p^).BGRA
          else if Color_Buff[p^].Found then
            begin
              SSOutput.FastPixel[i, pass] := Color_Buff[p^].color;
            end
          else if SS_ColorPool.GetIDColorAndToken(p^, RColor(0, 0, 0, $FF), '', Color_Buff[p^].color, tk) then
            begin
              Color_Buff[p^].Found := True;
...
begin
  ...
  p^.output := LVecCopy(FAI.Metric_ResNet_Process(MetricHnd, p^.Input));
  UpdateLastProcessRaster(p^.Input);
  DoRunEvent(p, OnComputeThreadResult);
end;
...
begin
  FThreadPost.PostM1(CMD_OpenShareFace);
end;
...
begin
  ...
  p^.OnResult_P := nil;
  SetLength(p^.output, 0);
  FThreadPost.PostM2(p, CMD_AsyncProcess);
end;
...
begin
  ...
  p^.output := FAI.MMOD6L_DNN_Process(MMOD6LHnd, p^.Input);
  UpdateLastProcessRaster(p^.Input);
  DoRunEvent(p, CMD_AsyncProcess_Result);
end;
...
begin
  ...
  Self.DoRunEvent(p, CMD_AsyncProcessMatrix_Result);
end;
...
begin
  FThreadPost.PostM1(CMD_OpenFace);
end;
...
begin
  ...
  p^.OnResult_P := nil;
  SetLength(p^.output, 0);
  FThreadPost.PostM2(p, CMD_AsyncProcessMatrix);
end;
...
begin
  ...
  UpdateLastProcessMatrixRaster(p^.Matrix_IMG);
  DoRunEvent(p, CMD_AsyncProcessMatrix_Result);
end;
...
begin
  p := data;
  p^.output := FAI.SS_Process(SSHnd, p^.Input, p^.SS_ColorPool, p^.SSTokenOutput);
  UpdateLastProcessRaster(p^.Input);
  p^.Done.V := True;
end;
...
function TPas_AI_DNN_Thread_SS.Process(Input: TMPasAI_Raster; SS_ColorPool: TSegmentationColorTable; SSTokenOutput: TPascalStringList): TMPasAI_Raster;
var
  CMD_: TCMD_SyncProcess;
begin
  CMD_.Done := TAtomBool.Create(False);
  CMD_.Input := Input;
  CMD_.SS_ColorPool := SS_ColorPool;
...
procedure TPas_AI_DNN_Thread_SS.ProcessC(UserData: Pointer; Input: TMPasAI_Raster; SS_ColorPool: TSegmentationColorTable; FreeInput: Boolean; OnResult: TPas_AI_DNN_Thread_SS_AsyncProcess_C);
var
  p: PCMD_AsyncProcess;
begin
  CheckGPUPerformanceCritical;
...
procedure TPas_AI_DNN_Thread_SS.ProcessM(UserData: Pointer; Input: TMPasAI_Raster; SS_ColorPool: TSegmentationColorTable; FreeInput: Boolean; OnResult: TPas_AI_DNN_Thread_SS_AsyncProcess_M);
var
  p: PCMD_AsyncProcess;
begin
  CheckGPUPerformanceCritical;
...
procedure TPas_AI_DNN_Thread_SS.ProcessP(UserData: Pointer; Input: TMPasAI_Raster; SS_ColorPool: TSegmentationColorTable; FreeInput: Boolean; OnResult: TPas_AI_DNN_Thread_SS_AsyncProcess_P);
var
  p: PCMD_AsyncProcess;
begin
  CheckGPUPerformanceCritical;
...
begin
  ...
  SetLength(arry, 0);
  DoRunEvent(p, CMD_AsyncProcess_List_Result);
end;
...
begin
  ...
  p^.OnResult_P := nil;
  SetLength(p^.output, 0, 0);
  FThreadPost.PostM2(p, CMD_AsyncProcess_List);
end;
...
begin
  Prepare_Parallel(Prepare_AI_Engine, poolSiz);
end;

procedure TPas_AI_Parallel.Prepare_Parallel;
begin
  Prepare_Parallel(Prepare_AI_Engine, PasAI.AI.Common.AI_Parallel_Count);
end;
...
{$IFDEF Parallel}
{$IFDEF FPC}
    FPCParallelFor(Count, True, 0, Count - 1, Do_ParallelFor);
{$ELSE FPC}
    DelphiParallelFor(Count, True, 0, Count - 1, procedure(pass: Integer)
      begin
        Items[pass].PrepareFaceDataSource;
      end);
{$ENDIF FPC}
...
begin
  ThSender.Thread_Info := PFormat('AI IO-Thread', []);
...
begin
  ...
  TCompute.RunM(UserData, Self, IOProcessorThreadRun);
end;
...
PasAI.AI.Tech2022.On_Prepare_AI_Engine_TECH_2022 := Do_Prepare_AI_Engine_TECH_2022;
PasAI.AI.Tech2022.On_Wait_AI_Init:=Wait_AI_Init;
