...
type
  TNavigationScene = class(TCore_Persistent_Intermediate)
  private
  ...
  public
    ...
    procedure AddPolygon(PointList: TV2L; ConvexHull: Boolean);
    procedure SetScene(PointList: TV2L);
...
procedure TNavigationScene.AddPolygon(PointList: TV2L; ConvexHull: Boolean);
begin
...
procedure TNavigationScene.SetScene(PointList: TV2L);
begin
  PointList.RemoveSame;
