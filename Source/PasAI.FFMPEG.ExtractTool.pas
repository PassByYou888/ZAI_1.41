...
type
  ...
  TFFMPEG_Extract_Tool_Codec_Stream_Pool_Decl = TGenericsList<PFFMPEG_Extract_Tool_Codec_Stream_>;
  ...
  TFFMPEG_Extract_Tool_Video_Transform = class(TCore_Object_Intermediate)
  public
  ...
  TFFMPEG_Extract_Tool = class(TCore_Object_Intermediate)
  private
    FURL: TPascalString;
