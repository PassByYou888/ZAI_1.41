 ...
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
unit PasAI.ICS9.OverbyteIcsZlibHigh;
...
{$IFDEF USE_ZLIB_OBJ}
   ...
   System.ZLib;
   {$ELSE}
    PasAI.ICS9.OverbyteIcsZLibObj;     {interface to access ZLIB C OBJ files}
   {$ENDIF}
{$ELSE}
    PasAI.ICS9.OverbyteIcsZLibDll;             {interface to access zLib1.dll} { AG V6.02 }
{$ENDIF}
