...
from where you set-up an account for ?.50 (about $9) which gives 100 message
credits and the SMS Works at https://thesmsworks.co.uk/ where you set-up an
account with a few free SMS messages, then spend a mininum of ?0 which buys
...
Apr 26, 2019  - V8.61 - Prevent TSslHttpCli events being overwritten by TSslHttpRest events.
                        ...
                        Added new TIcsSms component to send SMS text messages via
                           ...
                           an account for ?.50 (about $9) which gives 100 message
...
unit PasAI.ICS9.OverbyteIcsSslHttpRest;
{$ENDIF}
...
{$IFDEF FMX}
    ...
    PasAI.ICS9.Ics.Fmx.OverbyteIcsMsSslUtils,
    PasAI.ICS9.Ics.Fmx.OverbyteIcsSslJose,
    PasAI.ICS9.Ics.Fmx.OverbyteIcsDnsQuery,
    PasAI.ICS9.Ics.Fmx.OverbyteIcsPing,
    PasAI.ICS9.Ics.Fmx.OverbyteIcsIcmp,
{$ELSE}
    ...
    PasAI.ICS9.OverbyteIcsSslX509Utils,
    PasAI.ICS9.OverbyteIcsMsSslUtils,
    PasAI.ICS9.OverbyteIcsDnsQuery,
    PasAI.ICS9.OverbyteIcsPing,
    PasAI.ICS9.OverbyteIcsIcmp,
{$ENDIF FMX}
{$IFDEF MSWINDOWS}
    PasAI.ICS9.OverbyteIcsWinCrypt,
{$ENDIF MSWINDOWS}
    PasAI.ICS9.OverbyteIcsHttpCCodZLib,
    PasAI.ICS9.OverbyteIcsHttpContCod,
    PasAI.ICS9.OverbyteIcsLogger,         { for TLogOption }
    PasAI.ICS9.OverbyteIcsCookies,
    PasAI.ICS9.OverbyteIcsMimeUtils,
    PasAI.ICS9.OverbyteIcsFormDataDecoder,
    PasAI.ICS9.OverbyteIcsCharsetUtils,
    PasAI.ICS9.OverbyteIcsSuperObject,
    PasAI.ICS9.OverbyteIcsTicks64,
    PasAI.ICS9.OverbyteIcsStreams;   { V8.68 }
...
{$ENDIF}
 ...
 //   FDnsSrvUrlList: TStrings;     { V8.71 not supported yet }
  ...
  { V8.61 Send SMS using bureau, you will need an account.
    ...
    account for ?.50 (about $9) which gives 100 message credits.
