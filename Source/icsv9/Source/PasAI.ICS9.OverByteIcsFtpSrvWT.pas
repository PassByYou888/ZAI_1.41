 ...
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
unit PasAI.ICS9.OverByteIcsFtpSrvWT;
...
{$ENDIF}
    Classes, SysUtils,
    PasAI.ICS9.OverbyteIcsCRC,        { angus V7.7 }
    PasAI.ICS9.OverbyteIcsMD5,        { angus V7.7 }
    PasAI.ICS9.OverbyteIcsTypes,
    PasAI.ICS9.OverbyteIcsUtils,
    PasAI.ICS9.OverbyteIcsStreams;    { angus V7.7 }
...
begin
    Result := PasAI.ICS9.OverbyteIcsUtils.IcsGetLocalTimeZoneBias;
end;
