...
unit PasAI.ICS9.OverbyteIcsSslX509Utils;
{$ENDIF}
...
PEM bundle file sslRootCACertsBundle.pem built by Magenta Systems Ltd at 2023-07-06T17:29:46
...
Public Key: RSA Key Encryption 4096 bits, 152 security bits }
...
{
Issued to (CN): Sectigo Public Server Authentication Root E46, (O): Sectigo Limited
Issuer: Self Signed
Expires: 2046-03-21T23:59:59, Signature: ecdsa-with-SHA384
Valid From: 2021-03-22T00:00:00, Serial Number: 42f2ccda1b6937445f15fe752810b8f4
Fingerprint (sha256): c90f26f0fb1b4018b22227519b5ca2b53e2ca5b3be5cf18efe1bef47380c5383
Public Key: ECDSA Key Encryption secp384r1 384 bits, 192 security bits }

sslRootCACerts046 =
  '-----BEGIN CERTIFICATE-----'+#13#10+
  'MIICOjCCAcGgAwIBAgIQQvLM2htpN0RfFf51KBC49DAKBggqhkjOPQQDAzBfMQsw'+#13#10+
  'CQYDVQQGEwJHQjEYMBYGA1UEChMPU2VjdGlnbyBMaW1pdGVkMTYwNAYDVQQDEy1T'+#13#10+
  'ZWN0aWdvIFB1YmxpYyBTZXJ2ZXIgQXV0aGVudGljYXRpb24gUm9vdCBFNDYwHhcN'+#13#10+
  'MjEwMzIyMDAwMDAwWhcNNDYwMzIxMjM1OTU5WjBfMQswCQYDVQQGEwJHQjEYMBYG'+#13#10+
  'A1UEChMPU2VjdGlnbyBMaW1pdGVkMTYwNAYDVQQDEy1TZWN0aWdvIFB1YmxpYyBT'+#13#10+
  'ZXJ2ZXIgQXV0aGVudGljYXRpb24gUm9vdCBFNDYwdjAQBgcqhkjOPQIBBgUrgQQA'+#13#10+
  'IgNiAAR2+pmpbiDt+dd34wc7qNs9Xzjoq1WmVk/WSOrsfy2qw7LFeeyZYX8QeccC'+#13#10+
  'WvkEN/U0NSt3zn8gj1KjAIns1aeibVvjS5KToID1AZTc8GgHHs3u/iVStSBDHBv+'+#13#10+
  '6xnOQ6OjQjBAMB0GA1UdDgQWBBTRItpMWfFLXyY4qp3W7usNw/upYTAOBgNVHQ8B'+#13#10+
  'Af8EBAMCAYYwDwYDVR0TAQH/BAUwAwEB/zAKBggqhkjOPQQDAwNnADBkAjAn7qRa'+#13#10+
  'qCG76UeXlImldCBteU/IvZNeWBj7LRoAasm4PdCkT0RHlAFWovgzJQxC36oCMB3q'+#13#10+
  '4S6ILuH5px0CMk7yn2xVdOOurvulGu7t0vzCAxHrRVxgED1cf5kDW21USAGKcw=='+#13#10+
  '-----END CERTIFICATE-----'+#13#10;

{
Issued to (CN): Sectigo Public Server Authentication Root R46, (O): Sectigo Limited
Issuer: Self Signed
Expires: 2046-03-21T23:59:59, Signature: sha384WithRSAEncryption
Valid From: 2021-03-22T00:00:00, Serial Number: 758dfd8bae7c0700faa925a7e1c7ad14
Fingerprint (sha256): 7bb647a62aeeac88bf257aa522d01ffea395e0ab45c73f93f65654ec38f25a06
Public Key: RSA Key Encryption 4096 bits, 152 security bits }

sslRootCACerts047 =
  '-----BEGIN CERTIFICATE-----'+#13#10+
  'MIIFijCCA3KgAwIBAgIQdY39i658BwD6qSWn4cetFDANBgkqhkiG9w0BAQwFADBf'+#13#10+
  'MQswCQYDVQQGEwJHQjEYMBYGA1UEChMPU2VjdGlnbyBMaW1pdGVkMTYwNAYDVQQD'+#13#10+
  'Ey1TZWN0aWdvIFB1YmxpYyBTZXJ2ZXIgQXV0aGVudGljYXRpb24gUm9vdCBSNDYw'+#13#10+
  'HhcNMjEwMzIyMDAwMDAwWhcNNDYwMzIxMjM1OTU5WjBfMQswCQYDVQQGEwJHQjEY'+#13#10+
  'MBYGA1UEChMPU2VjdGlnbyBMaW1pdGVkMTYwNAYDVQQDEy1TZWN0aWdvIFB1Ymxp'+#13#10+
  'YyBTZXJ2ZXIgQXV0aGVudGljYXRpb24gUm9vdCBSNDYwggIiMA0GCSqGSIb3DQEB'+#13#10+
  'AQUAA4ICDwAwggIKAoICAQCTvtU2UnXYASOgHEdCSe5jtrch/cSV1UgrJnwUUxDa'+#13#10+
  'ef0rty2k1Cz66jLdScK5vQ9IPXtamFSvnl0xdE8H/FAh3aTPaE8bEmNtJZlMKpnz'+#13#10+
  'SDBh+oF8HqcIStw+KxwfGExxqjWMrfhu6DtK2eWUAtaJhBOqbchPM8xQljeSM9xf'+#13#10+
  'iOefVNlI8JhD1mb9nxc4Q8UBUQvX4yMPFF1bFOdLvt30yNoDN9HWOaEhUTCDsG3X'+#13#10+
  'ME6WW5HwcCSrv0WBZEMNvSE6Lzzpng3LILVCJ8zab5vuZDCQOc2TZYEhMbUjUDM3'+#13#10+
  'IuM47fgxMMxF/mL50V0yeUKH32rMVhlATc6qu/m1dkmU8Sf4kaWD5QazYw6A3OAS'+#13#10+
  'VYCmO2a0OYctyPDQ0RTp5A1NDvZdV3LFOxxHVp3i1fuBYYzMTYCQNFu31xR13NgE'+#13#10+
  'SJ/AwSiItOkcyqex8Va3e0lMWeUgFaiEAin6OJRpmkkGj80feRQXEgyDet4fsZfu'+#13#10+
  '+Zd4KKTIRJLpfSYFplhym3kT2BFfrsU4YjRosoYwjviQYZ4ybPUHNs2iTG7sijbt'+#13#10+
  '8uaZFURww3y8nDnAtOFr94MlI1fZEoDlSfB1D++N6xybVCi0ITz8fAr/73trdf+L'+#13#10+
  'HaAZBav6+CuBQug4urv7qv094PPK306Xlynt8xhW6aWWrL3DkJiy4Pmi1KZHQ3xt'+#13#10+
  'zwIDAQABo0IwQDAdBgNVHQ4EFgQUVnNYZJX5khqwEioEYnmhQBWIIUkwDgYDVR0P'+#13#10+
  'AQH/BAQDAgGGMA8GA1UdEwEB/wQFMAMBAf8wDQYJKoZIhvcNAQEMBQADggIBAC9c'+#13#10+
  'mTz8Bl6MlC5w6tIyMY208FHVvArzZJ8HXtXBc2hkeqK5Duj5XYUtqDdFqij0lgVQ'+#13#10+
  'YKlJfp/imTYpE0RHap1VIDzYm/EDMrraQKFz6oOht0SmDpkBm+S8f74TlH7Kph52'+#13#10+
  'gDY9hAaLMyZlbcp+nv4fjFg4exqDsQ+8FxG75gbMY/qB8oFM2gsQa6H61SilzwZA'+#13#10+
  'Fv97fRheORKkU55+MkIQpiGRqRxOF3yEvJ+M0ejf5lG5Nkc/kLnHvALcWxxPDkjB'+#13#10+
  'JYOcCj+esQMzEhonrPcibCTRAUH4WAP+JWgiH5paPHxsnnVI84HxZmduTILA7rpX'+#13#10+
  'DhjvLpr3Etiga+kFpaHpaPi8TD8SHkXoUsCjvxInebnMMTzD9joiFgOgyY9mpFui'+#13#10+
  'TdaBJQbpdqQACj7LzTWb4OE4y2BThihCQRxEV+ioratF4yUQvNs+ZUH7G6aXD+u5'+#13#10+
  'dHn5HrwdVw1Hr8Mvn4dGp+smWg9WY7ViYG4A++MnESLn/pmPNPW56MORcr3Ywx65'+#13#10+
  'LvKRRFHQV80MNNVIIb/bE/FmJUNS0nAiNs2fxBx1IK1jcmMGDw4nztJqDby1ORrp'+#13#10+
  '0XZ60Vzk50lJLVU3aPAaOpg+VBeHVOmmJ1CJeyAvP/+/oYtKR5j/K3tJPsMpRmAY'+#13#10+
  'QqszKbrAKbkTidOIijlBO8n9pu0f9GBj39ItVQGL'+#13#10+
  '-----END CERTIFICATE-----'+#13#10;
...
begin
    result :=
        ...
        sslRootCACerts051 + sslRootCACerts052 + sslRootCACerts053 + sslRootCACerts054 ;   { V8.69 some gone, V8.71 1 more }
    end ;
...
begin
    ...
    {    SetX509Req(LSource.X509Req);    in inherited
        SetX509CA(LSource.X509CA);
        SetPrivKeyCA(LSource.PrivKeyCA);     }
