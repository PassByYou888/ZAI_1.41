...
unit PasAI.ICS9.OverbyteIcsDnsQuery;
{$ENDIF}
...
{$IFDEF FMX}
    PasAI.ICS9.Ics.Fmx.OverbyteIcsWndControl, { V8.71 }
    PasAI.ICS9.Ics.Fmx.OverbyteIcsWSocket,
    PasAI.ICS9.Ics.Fmx.OverbyteIcsIpUtils,    { V8.71 }
{$ELSE}
    PasAI.ICS9.OverbyteIcsWndControl,    { V8.71 }
    PasAI.ICS9.OverbyteIcsWSocket,
    PasAI.ICS9.OverbyteIcsIpUtils,       { V8.71 }
{$ENDIF}
