...
unit PasAI.ICS9.OverbyteIcsHttpMulti;
{$ENDIF}
...
{$ENDIF FMX}
  ...
  PasAI.ICS9.OverbyteIcsHtmlPars,
...
var
    ...
    nsep1, nsep2: integer ;
begin
    PasAI.ICS9.OverbyteIcsUrl.ParseURL (url, Proto, User, Pass, Host, Port, path) ;
    Dirs := '' ;
    Fname := '' ;
    Section := '' ;
    Query := '' ;
