...
type
  ...
  protected
    ...
    function MorphExp_DrawToPasAI_Raster(OpRunTime: TOpCustomRunTime; OP_RT_Data: POpRTData; var Param: TOpParam): Variant;
    function MorphExp_LFBlendPasAI_Raster(OpRunTime: TOpCustomRunTime; OP_RT_Data: POpRTData; var Param: TOpParam): Variant;
    function MorphExp_RFBlendPasAI_Raster(OpRunTime: TOpCustomRunTime; OP_RT_Data: POpRTData; var Param: TOpParam): Variant;
    ...
    function MorphExp_PasAI_Raster(OpRunTime: TOpCustomRunTime; OP_RT_Data: POpRTData; var Param: TOpParam): Variant;
    function MorphExp_CombineMorphToPasAI_Raster(OpRunTime: TOpCustomRunTime; OP_RT_Data: POpRTData; var Param: TOpParam): Variant;
...
begin
  ...
  Exp.Reg_RT_OpM('Draw', 'Draw(token,TMorphologyPixel): draw raster ', MorphExp_DrawToPasAI_Raster)^.Category := 'Morphology';
  Exp.Reg_RT_OpM('LFBlend', 'LFBlend(token..n): left to right blend raster ', MorphExp_LFBlendPasAI_Raster)^.Category := 'Morphology';
  Exp.Reg_RT_OpM('RFBlend', 'RFBlend(token..n): right to left blend raster ', MorphExp_RFBlendPasAI_Raster)^.Category := 'Morphology';
  ...
  Exp.Reg_RT_OpM('Raster', 'Raster(): build raster ', MorphExp_PasAI_Raster)^.Category := 'Morphology';
  Exp.Reg_RT_OpM('CombineMorphToRaster', 'CombineMorphToRaster(TMorphologyPixel,Morphomatics data): Combine Morph as new raster ', MorphExp_CombineMorphToPasAI_Raster)^.Category := 'Morphology';
...
function TExp_API.MorphExp_DrawToPasAI_Raster(OpRunTime: TOpCustomRunTime; OP_RT_Data: POpRTData; var Param: TOpParam): Variant;
var
  meRT: TMorphExpRunTime;
...
function TExp_API.MorphExp_LFBlendPasAI_Raster(OpRunTime: TOpCustomRunTime; OP_RT_Data: POpRTData; var Param: TOpParam): Variant;
var
  meRT: TMorphExpRunTime;
  i: Integer;
  n: U_String;
...
function TExp_API.MorphExp_RFBlendPasAI_Raster(OpRunTime: TOpCustomRunTime; OP_RT_Data: POpRTData; var Param: TOpParam): Variant;
var
  meRT: TMorphExpRunTime;
  i: Integer;
  n: U_String;
...
function TExp_API.MorphExp_PasAI_Raster(OpRunTime: TOpCustomRunTime; OP_RT_Data: POpRTData; var Param: TOpParam): Variant;
var
  meRT: TMorphExpRunTime;
begin
  meRT := OpRunTime as TMorphExpRunTime;
...
function TExp_API.MorphExp_CombineMorphToPasAI_Raster(OpRunTime: TOpCustomRunTime; OP_RT_Data: POpRTData; var Param: TOpParam): Variant;
var
  meRT: TMorphExpRunTime;
  i: Integer;
  n: U_String;
